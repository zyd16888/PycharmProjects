...
SCKEY = "SCU21432T3b2370a9ad026d7d7136ede92fcc176c5a782ec391d27"
SCKEY2 = "SCU78813T826445a1ce5528a6b16f4aac30d33e325e2be1476724e"
...
def main():
    ...
    if new_id != last_id:
        ...
        # push_wechat(title, message, SCKEY2)
        # time.sleep(120 + random.randint(10, 30))
    else:
        print('与上条消息相同')
        print(news)
        pass
